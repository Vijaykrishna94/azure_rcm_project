...
df_hosa=spark.read.parquet("/mnt/bronze/hosa/providers").withColumn("datasource",f.lit("hosa"))

#Reading Hospital B departments data 
df_hosb=spark.read.parquet("/mnt/bronze/hosb/providers").withColumn("datasource",f.lit("hosb"))
